...
/* var nodemailer = require('nodemailer');
 ...
 var mailOptions = {
   ...
   html: '<a href="http://localhost:3000/register?">That was easy!'
 };
...
app.post('/saveUserForm', function (req, res) {
  ...
  db.serialize(function () {
    // db.run("DROP TABLE db.admin_info");
    db.run("CREATE TABLE if not exists user_info (email TEXT, name TEXT, url TEXT, coverLetter TEXT, likeWorking TEXT, PRIMARY KEY(email))");
